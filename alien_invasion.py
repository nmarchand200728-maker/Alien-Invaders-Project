...
class AlienInvasion:
    ...
    def _create_fleet(self):
          """Create the fleet."""
          #Make an alien and keep adding them.
    ...
    def _check_bullet_alien_collisions(self):
         ...
         #Check for any bullets that hit aliens and get rid of both.
    ...
    def _ship_hit(self):
         """Respond the the ship being hit."""
    ...
    def _update_aliens(self):
         """Check if the fleet is at an edge and then update position accordingly."""
